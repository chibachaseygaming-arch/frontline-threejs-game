...
type Bot = { mesh: THREE.Group; team: "RED" | "BLUE"; hp: number; target: THREE.Vector3; cooldown: number; skill: keyof typeof DIFFICULTIES; classKey: ClassKey; bar: THREE.Mesh; dying?: boolean; deathStarted?: number; fallDirection?: number };
...
export default function Game() {
  ...
  useEffect(() => {
    ...
    const shoot=()=>{
      ...
      if(performance.now()-lastShot<spec.rate||ammo<=0)return;lastShot=performance.now();ammo--;shotSound();gun.position.z=.08;
